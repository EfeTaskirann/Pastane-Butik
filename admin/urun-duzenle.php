        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <?php if ($product['gorsel']): ?>
                    <div class="u-flex-row-gap-4 u-align-center u-mb-4">
                        <img src="../uploads/products/<?= e($product['gorsel']) ?>" alt="<?= e($product['isim']) ?>" class="u-icon-img-preview" loading="lazy" decoding="async">
                        <label class="u-check-row-danger">
            ...
            <div class="form-group u-info-banner">
                ...
                <div class="u-grid-3">
                    <div class="form-group u-mb-0">
                        <label class="u-check-row">
                            <input type="checkbox" name="cafe_menusu" value="1" <?= (isset($_POST['cafe_menusu']) ? $_POST['cafe_menusu'] : ($product['cafe_menusu'] ?? 1)) ? 'checked' : '' ?>>
                            QR menüde görünsün
                        </label>
                    </div>
                    <div class="form-group u-mb-0">
                        ...
                        <input type="number" id="hazirlanma_suresi" name="hazirlanma_suresi" class="form-control" min="0" max="300"
                               value="<?= e($_POST['hazirlanma_suresi'] ?? $product['hazirlanma_suresi'] ?? '') ?>" placeholder="örn: 15">
                    </div>
                    <div class="form-group u-mb-0">
                        <label for="stok_durumu">Stok Durumu</label>
                        <select id="stok_durumu" name="stok_durumu" class="form-control">
                            <?php $curStok = $_POST['stok_durumu'] ?? $product['stok_durumu'] ?? 'var'; ?>
